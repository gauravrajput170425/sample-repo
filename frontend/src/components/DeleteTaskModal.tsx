...
const DeleteTaskModal = ({ isOpen, onClose, onConfirm }: DeleteTaskModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#00000066] flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-[90%] max-w-[500px] relative shadow-lg">
        ...
        <h2 className="text-xl font-semibold mb-4 text-center">Are you sure you want to delete this task?</h2>
        
        <p className="mb-6 text-gray-600 text-center leading-relaxed">This action cannot be undone.</p>
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button 
            className="py-3 px-6 bg-red-600 text-white rounded text-sm font-medium hover:bg-red-700"
            onClick={onConfirm}
          >
            Delete Task
          </button>
